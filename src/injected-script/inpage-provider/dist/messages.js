...
const messages = {
  ...
  warnings: {
    // deprecated methods
    enableDeprecation: `MetaMask: 'vite.enable()' is deprecated and may be removed in the future. Please use the 'vite_requestAccounts' RPC method instead.\nFor more information, see: https://eips.ethereum.org/EIPS/eip-1102`,
    sendDeprecation: `MetaMask: 'vite.send(...)' is deprecated and may be removed in the future. Please use 'vite.sendAsync(...)' or 'vite.request(...)' instead.\nFor more information, see: https://eips.ethereum.org/EIPS/eip-1193`,
    // deprecated events
    events: {
    ...
    // misc
    experimentalMethods: `MetaMask: 'vite._metamask' exposes non-standard, experimental methods. They may be removed or changed without warning.`,
  },
};
