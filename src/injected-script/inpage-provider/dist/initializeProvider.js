...
/**
 * Initializes a MetaMaskInpageProvider and (optionally) assigns it as window.vite.
 *
 ...
 * @param options.shouldSetOnWindow - Whether the provider should be set as window.vite.
...
/**
 * Sets the given provider instance as window.vite and dispatches the
 * 'vite#initialized' event on window.
 *
 * @param providerInstance - The provider instance.
 */
function setGlobalProvider(providerInstance) {
    window.vite = providerInstance;
    window.dispatchEvent(new Event('vite#initialized'));
}
